...
def main():
    ...
    result_list = run_imap_multiprocessing(
    ...
    result_list = run_imap_unordered_multiprocessing(
        func=func, argument_list=argument_list, num_processes=num_processes
    )
    ...
    result_list = run_imap_multiprocessing(
        func=partial_func, argument_list=argument_list, num_processes=num_processes
    )
    print(
    ...
    argument_list = [
        (random.randint(0, 100), random.randint(0, 100)) for _ in range(num_jobs)
    ]
    ...
    partial_func = partial(
        func_multiple_argument, x=1, y=2, z=3
